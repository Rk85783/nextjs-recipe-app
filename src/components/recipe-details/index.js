...
export default function RecipeDetailsItem({ getRecipeDetails }) {
	return (
		<>
			<Link href={"/recipe-list"}>Go to recipe list</Link><div className="p-6 lg:max-w-6xl max-w-2xl mx-auto">
					...
					<div className="">
						...
						<div className="mt-5">
							...
							<ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-700">
								{getRecipeDetails?.ingredients.map(item => <li className="">{item}</li>)}
							</ul>
						</div>
					</div>
				</div>
